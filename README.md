...
If you are using your own hook scripts to redirect traffic to AegirPS instead of AegirPS's frida hook, many features that relies on hooking might be broken, e.g. 3x speed, pause-and-deploy, hp display, forever activity, mods etc.
